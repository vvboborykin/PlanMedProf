...
namespace PlanMedProf.Blazor.Server {
    public partial class PlanMedProfBlazorApplication : BlazorApplication {
        public PlanMedProfBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void PlanMedProfBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
